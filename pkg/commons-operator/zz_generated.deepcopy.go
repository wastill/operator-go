...
func (in *DatabaseProvider) DeepCopyInto(out *DatabaseProvider) {
	*out = *in
	if in.MysqlProvider != nil {
		in, out := &in.MysqlProvider, &out.MysqlProvider
		*out = new(MysqlProvider)
		(*in).DeepCopyInto(*out)
	}
	if in.PostgresProvider != nil {
		in, out := &in.PostgresProvider, &out.PostgresProvider
		*out = new(PostgresProvider)
		(*in).DeepCopyInto(*out)
	}
	if in.RedisProvider != nil {
		in, out := &in.RedisProvider, &out.RedisProvider
